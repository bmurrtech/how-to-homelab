...
#### Windows Updates
```
fe2cr.update.microsoft.com client.wns.windows.com ctdl.windowsupdate.com dl.delivery.mp.microsoft.com dl.delivery.mp.microsoft.com msedge.b.tlu.dl.delivery.mp.microsoft.com deff.nelreports.net aefd.nelreports.net aefd.nelreports.net
```

#### My Neccessary Wildcard  Whitelist 
```
pihole --white-regex (\.|^)roblox\.com$ (\.|^)typesy\.com$ (\.|^)youtubekids\.com$ (\.|^)rbxcdn\.com$ 	(\.|^)autodesk\.com$ (\.|^)launchdarkly\.com$ 	(\.|^)recaptcha\.net$ (\.|^)tiqcdn\.com$ (\.|^)gstatic\.com$ (\.|^)kidsafeseal\.com$ (\.|^)autodesk\.net$ (\.|^)contentful\.com$ (\.|^)bitwarden\.com$ (\.|^)apple\.com$ (\.|^)microsoft\.com$
```
